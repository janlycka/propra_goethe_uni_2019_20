...
public:
    ...
    void retranslateUi(QWidget *cryptographytab)
    {
        ...
        pushButton_3->setText(QCoreApplication::translate("cryptographytab", "Import Key", nullptr));
        ...
        pushButton_2->setText(QCoreApplication::translate("cryptographytab", "Import Bild", nullptr));
